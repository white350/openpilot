...
_AWARENESS_PRE_TIME_TILL_TERMINAL = 180.  # a first alert is issued 180s before expiration
_AWARENESS_PROMPT_TIME_TILL_TERMINAL = 60.  # a second alert is issued 60s before start decelerating the car
_DISTRACTED_TIME = 700.
_DISTRACTED_PRE_TIME_TILL_TERMINAL = 400.
_DISTRACTED_PROMPT_TIME_TILL_TERMINAL = 200.
